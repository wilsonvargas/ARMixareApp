 ...
 * Original file: D:\\Proyectos\\AppVisita\\arLib\\src\\main\\aidl\\org\\ar\\lib\\service\\IMarkerService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements org.ar.lib.service.IMarkerService
{
private static final java.lang.String DESCRIPTOR = "org.ar.lib.service.IMarkerService";
...
/**
 * Cast an IBinder object into an org.ar.lib.service.IMarkerService interface,
 * generating a proxy if needed.
 */
public static org.ar.lib.service.IMarkerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.ar.lib.service.IMarkerService))) {
return ((org.ar.lib.service.IMarkerService)iin);
}
return new org.ar.lib.service.IMarkerService.Stub.Proxy(obj);
}
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.render.ArVector _result = this.getLocationVector(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.render.Camera _arg1;
if ((0!=data.readInt())) {
_arg1 = org.ar.lib.render.Camera.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.marker.draw.DrawCommand[] _result = this.remoteDraw(_arg0);
reply.writeNoException();
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.marker.draw.ClickHandler _result = this.fClick(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
java.lang.String _arg1;
_arg1 = data.readString();
org.ar.lib.marker.draw.ParcelableProperty _arg2;
if ((0!=data.readInt())) {
_arg2 = org.ar.lib.marker.draw.ParcelableProperty.CREATOR.createFromParcel(data);
}
else {
_arg2 = null;
}
...
java.lang.String _arg1;
_arg1 = data.readString();
org.ar.lib.marker.draw.PrimitiveProperty _arg2;
if ((0!=data.readInt())) {
_arg2 = org.ar.lib.marker.draw.PrimitiveProperty.CREATOR.createFromParcel(data);
}
else {
_arg2 = null;
}
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.render.ArVector _result = this.getCMarker(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.render.ArVector _result = this.getSignMarker(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.gui.Label _arg1;
if ((0!=data.readInt())) {
_arg1 = org.ar.lib.gui.Label.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
java.lang.String _arg0;
_arg0 = data.readString();
org.ar.lib.gui.Label _result = this.getTxtLab(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements org.ar.lib.service.IMarkerService
{
...
@Override public org.ar.lib.render.ArVector getLocationVector(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.render.ArVector _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(markerName);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = org.ar.lib.render.ArVector.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void calcPaint(java.lang.String markerName, org.ar.lib.render.Camera viewCam, float addX, float addY) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public org.ar.lib.marker.draw.DrawCommand[] remoteDraw(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.marker.draw.DrawCommand[] _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(markerName);
mRemote.transact(Stub.TRANSACTION_remoteDraw, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArray(org.ar.lib.marker.draw.DrawCommand.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public org.ar.lib.marker.draw.ClickHandler fClick(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.marker.draw.ClickHandler _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(markerName);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = org.ar.lib.marker.draw.ClickHandler.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void setExtrasParc(java.lang.String markerName, java.lang.String name, org.ar.lib.marker.draw.ParcelableProperty parcelableProperty) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setExtrasPrim(java.lang.String markerName, java.lang.String name, org.ar.lib.marker.draw.PrimitiveProperty primitiveProperty) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public org.ar.lib.render.ArVector getCMarker(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.render.ArVector _result;
...
@Override public org.ar.lib.render.ArVector getSignMarker(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.render.ArVector _result;
...
@Override public void setTxtLab(java.lang.String markerName, org.ar.lib.gui.Label txtLab) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public org.ar.lib.gui.Label getTxtLab(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.ar.lib.gui.Label _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(markerName);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = org.ar.lib.gui.Label.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public org.ar.lib.render.ArVector getLocationVector(java.lang.String markerName) throws android.os.RemoteException;
public void update(java.lang.String markerName, android.location.Location curGPSFix) throws android.os.RemoteException;
public void calcPaint(java.lang.String markerName, org.ar.lib.render.Camera viewCam, float addX, float addY) throws android.os.RemoteException;
public org.ar.lib.marker.draw.DrawCommand[] remoteDraw(java.lang.String markerName) throws android.os.RemoteException;
...
public org.ar.lib.marker.draw.ClickHandler fClick(java.lang.String markerName) throws android.os.RemoteException;
public boolean isVisible(java.lang.String markerName) throws android.os.RemoteException;
public void setExtrasParc(java.lang.String markerName, java.lang.String name, org.ar.lib.marker.draw.ParcelableProperty parcelableProperty) throws android.os.RemoteException;
public void setExtrasPrim(java.lang.String markerName, java.lang.String name, org.ar.lib.marker.draw.PrimitiveProperty primitiveProperty) throws android.os.RemoteException;
public org.ar.lib.render.ArVector getCMarker(java.lang.String markerName) throws android.os.RemoteException;
public org.ar.lib.render.ArVector getSignMarker(java.lang.String markerName) throws android.os.RemoteException;
public boolean getUnderline(java.lang.String markerName) throws android.os.RemoteException;
public void setTxtLab(java.lang.String markerName, org.ar.lib.gui.Label txtLab) throws android.os.RemoteException;
public org.ar.lib.gui.Label getTxtLab(java.lang.String markerName) throws android.os.RemoteException;
}
