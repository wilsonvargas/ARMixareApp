 ...
 * Original file: D:\\Proyectos\\AppVisita\\arLib\\src\\main\\aidl\\org\\ar\\lib\\service\\IDataHandlerService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements org.ar.lib.service.IDataHandlerService
{
private static final java.lang.String DESCRIPTOR = "org.ar.lib.service.IDataHandlerService";
...
/**
 * Cast an IBinder object into an org.ar.lib.service.IDataHandlerService interface,
 * generating a proxy if needed.
 */
public static org.ar.lib.service.IDataHandlerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.ar.lib.service.IDataHandlerService))) {
return ((org.ar.lib.service.IDataHandlerService)iin);
}
return new org.ar.lib.service.IDataHandlerService.Stub.Proxy(obj);
}
...
int _arg3;
_arg3 = data.readInt();
java.util.List<org.ar.lib.marker.InitialMarkerData> _result = this.load(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
...
private static class Proxy implements org.ar.lib.service.IDataHandlerService
{
...
@Override public java.util.List<org.ar.lib.marker.InitialMarkerData> load(java.lang.String processorName, java.lang.String rawData, int taskId, int colour) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<org.ar.lib.marker.InitialMarkerData> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(processorName);
...
_reply.readException();
_result = _reply.createTypedArrayList(org.ar.lib.marker.InitialMarkerData.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public java.util.List<org.ar.lib.marker.InitialMarkerData> load(java.lang.String processorName, java.lang.String rawData, int taskId, int colour) throws android.os.RemoteException;
}
