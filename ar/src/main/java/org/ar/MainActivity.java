...
/**
 * This is the main activity of ar, that will be opened if ar is
...
public class MainActivity extends Activity {
    ...
    private final String usePluginsPrefs = "arUsePluginsPrefs";
    ...
    private void processCheckbox(boolean loadplugin, CheckBox checkBox) {
        if (checkBox.isChecked()) {
            SharedPreferences sharedPreferences = getSharedPreferences(usePluginsPrefs,
                    MODE_PRIVATE);
