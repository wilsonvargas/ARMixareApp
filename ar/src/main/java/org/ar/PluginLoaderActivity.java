...
import org.ar.plugin.PluginType;

/**
 * This is the plugin loading activity for ar. This activity will load a splashscreen and
 * then initializes the PluginLoader
 * It will then launch the visible bootstrap plugins and waits for their results. After all
 * bootstrap plugins are loaded
 * then ar will be launched.
 *
 * @author A.Egal
 */
