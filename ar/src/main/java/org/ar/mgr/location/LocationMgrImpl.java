...
class LocationMgrImpl implements LocationFinder {
    ...
    public LocationMgrImpl(ArContext ArContext) {
     ...
     *
     * @see
     * org.ar.mgr.location.LocationFinder#findLocation(android.content.Context
     * )
     */
    public void findLocation() {
        ...
        try {
            ...
            // ex2.printStackTrace();
            curLoc = hardFix;
            ArContext.doPopUp(R.string.connection_GPS_dialog_text);
    ...
    private void requestBestLocationUpdates() {
        ...
        timer.schedule(new LocationTimerTask(), 20 * 1000); //wait 20 seconds for the location
        // updates to find the location
    }
     ...
     *
     * @see
     * org.ar.mgr.location.LocationFinder#locationCallback(android.content
     * .Context)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.ar.mgr.location.LocationFinder#getCurrentLocation()
     */
    public Location getCurrentLocation() {
        if (curLoc == null) {
            // TODO mostrar mensaje si han pasado unos segundos y no encuentra location
//            ArView ArView = ArContext.getActualArView();
//            Toast.makeText(
//                    ArView,
//                    ArView.getResources().getString(
...
//                    .show();
     ...
     * (non-Javadoc)
     *
     * @see org.ar.mgr.location.LocationFinder#getLocationAtLastDownload()
     */
     ...
     *
     * @see
     * org.ar.mgr.location.LocationFinder#setLocationAtLastDownload(android
     * .location.Location)
     */
     ...
     *
     * @see
     * org.ar.mgr.location.LocationFinder#setDownloadManager(org.ar.
     ...
     * (non-Javadoc)
     *
     * @see org.ar.mgr.location.LocationFinder#getGeomagneticField()
     */
    ...
    public void setPosition(Location location) {
        ...
        ArContext.getActualArView().refresh();
        ...
        public void run() {
            ...
            if (bestLocationProvider != null) {
                ...
                ArContext.getActualArView().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(ArContext.getActualArView(),
                                ArContext.getActualArView().getResources().getString(
                                        R.string.location_not_found), Toast.LENGTH_LONG);
                    }
                });
